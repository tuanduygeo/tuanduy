...
# Khởi tạo tài khoản (đơn giản nhất, cho test)
names = ['admin', 'user1']
usernames = ['admin', 'user1']
passwords = ['123456', 'mypassword']
hashed_passwords = stauth.Hasher(passwords).generate()

# Bạn có thể đổi seed cookie hoặc quản lý user qua file yaml (nâng cao hơn)
authenticator = stauth.Authenticate(
    names, usernames, hashed_passwords,
    'phongthuy_app', 'abcdef', cookie_expiry_days=1
)
