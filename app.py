        ...
        try:
            ...
            if not os.path.exists(hgt_path):
                ...
                if 337.5<=float(bearing)<352.5:
                    n=(" 1.Toạ Bính(-2) Tấn 6 kim khắc xuất hướng Nhâm -1 thuỷ nên là cục toạ Tấn nghi Thoái. Hùng dự Hùng<br>     2. Cửa chính,phụ: Mở ở hướng bính tỵ, Tân, Dậu, Mùi Khôn, Sửu <br>      3.Cung vị sơn:            sơn Nhâm Hợi(tôn), Cấn(tử), Ất Mão(tử)     là thoái thần <br>  cần có núi, nhà cao, nhiều nhà ở xa từ 100 đến 1500m. Nếu ở sơn có thủy thì là phản ngâm chủ bại nhân đinh   <br>   -   sơn mùi khôn, tân dậu, sửu, bính tỵ    là tấn thần.<br>Các sơn này có núi, nhà cao tầng, nhiều nhà trong 100m trở lại.<br>    4. Các cung vị thuỷ:    tý quý(tôn), thân canh(tử), tuất(tử)   là thoái thần. <br>    Các sơn này có thuỷ, ngã tư đường, công viên bãi đỗ xe từ 100 đến 1500m. Nếu các thủy này lại có sơn là phục ngâm, chủ bại tài.<br>     - Các sơn giáp dần, tốn thìn, ngọ đinh, càn   là tấn thần. Cần có thủy trong 100m." )
                elif 352.5<=float(bearing)<360:
                    n=(" 1.Toạ Ngọ(-6) Tấn 6 kim khắc xuất hướng Tý 1 thuỷ nên là cục toạ Tấn nghi Thoái. Hùng dự Thư<br>     2. Cửa chính,phụ: Mở ở hướng giáp,dần,thìn tốn,đinh ngọ, càn <br>      3.Cung vị sơn:          sơn quý tý(tôn), canh thân(tử), tuất(tử)    là thoái thần <br>  cần có núi, nhà cao, nhiều nhà ở xa từ 100 đến 1500m. Nếu ở sơn có thủy thì là phản ngâm chủ bại nhân đinh <br>   -   sơn giáp dần, tốn, đinh ngọ, càn    là tấn thần. <br>    Các sơn này có núi, nhà cao tầng, nhiều nhà trong 100m trở lại.  <br>4. Các cung vị thuỷ:   nhâm hợi(tôn), cấn(tử), ất mão(tử)   là thoái thần. <br> Các sơn này có thuỷ, ngã tư đường, công viên bãi đỗ xe từ 100 đến 1500m. Nếu các thủy này lại có sơn là phục ngâm, chủ bại tài   <br>  - Các sơn sửu, bính tỵ, mùi khôn, tân dậu   là tấn thần.<br> Các sơn này cần có thủy trong 100m ")
                    ...
                    n=(" 1.Toạ Đinh(-1) Tấn 6 kim khắc xuất hướng Quý 1 thuỷ nên là cục toạ Tấn nghi Thoái. Thư dự Hùng<br> 2. Cửa chính,phụ: Mở ở hướng giáp,dần, thìn tốn,đinh ngọ, càn <br> 3.Cung vị sơn:    sơn quý tý(tôn), canh thân(tử), tuất(tử)    là thoái thần <br> cần có núi, nhà cao, nhiều nhà ở xa từ 100 đến 1500m. Nếu ở sơn có thủy thì là phản ngâm chủ bại nhân đinh <br> -   sơn giáp dần, tốn, đinh ngọ, càn    là tấn thần. <br> Các sơn này có núi, nhà cao tầng, nhiều nhà trong 100m trở lại.  <br>4. Các cung vị thuỷ:   nhâm hợi(tôn), cấn(tử), ất mão(tử)   là thoái thần. <br> Các sơn này có thuỷ, ngã tư đường, công viên bãi đỗ xe từ 100 đến 1500m. Nếu các thủy này lại có sơn là phục ngâm, chủ bại tài   <br>  - Các sơn sửu, bính tỵ, mùi khôn, tân dậu   là tấn thần.<br>   Các sơn này cần có thủy trong 100m ")
                elif 22.5<=float(bearing)<37.5:
                    n=(" 1.Toạ Mùi(2) Thoái 4 mộc sinh xuất hướng Sửu 9 hoả nên là cục toạ Thoái nghi Thoái. Hùng dự Hùng<br> 2. Cửa chính,phụ: Mở ở hướng sửu, bính,tỵ,khôn<br> 3.Cung vị sơn:      sơn sửu(tử), bính tỵ(tôn), khôn(tôn) khắc xuất là thoái thần <br> cần có núi, nhà cao, nhiều nhà ở xa từ 100 đến 1500m. Nếu ở sơn có thủy thì là phản ngâm chủ bại nhân đinh <br> -   sơn nhâm hợi,cấn,ất mão, mùi, dậu tân    là tấn thần. <br> Các sơn này có núi, nhà cao tầng, nhiều nhà trong 100m trở lại.  <br>4. Các cung vị thuỷ:    càn(tử), thìn(tôn), đinh ngọ(tôn)   là thoái thần. <br> Các sơn này có thuỷ, ngã tư đường, công viên bãi đỗ xe từ 100 đến 1500m. Nếu các thủy này lại có sơn là phục ngâm, chủ bại tài   <br>  - Các sơn canh thân, tuất, quý tý, giáp dần, tốn   là tấn thần.<br> Các sơn này cần có thủy trong 100m  ")
                elif 37.5<=float(bearing)<52.5:
                    n=(" 1.Toạ Khôn(7) Thoái 7 kim sinh xuất hướng Cấn 2 thổ nên là cục toạ Thoái nghi Thoái. Thư dự Thư<br> 2. Cửa chính,phụ: Mở ở hướng cấn, ất mão, nhâm hợi  <br> 3.Cung vị sơn:      sơn nhâm hợi(tôn),cấn(tử),ất mão(tử)    là thoái thần <br> cần có núi, nhà cao, nhiều nhà ở xa từ 100 đến 1500m. Nếu ở sơn có thủy thì là phản ngâm chủ bại nhân đinh <br> -   sơn tân dậu,sửu, mùi khôn, tị bính    là tấn thần. <br> Các sơn này có núi, nhà cao tầng, nhiều nhà trong 100m trở lại.  <br>4. Các cung vị thuỷ:    canh thân(tử), tuất(tử), quý tý(tôn)   là thoái thần. <br> Các sơn này có thuỷ, ngã tư đường, công viên bãi đỗ xe từ 100 đến 1500m. Nếu các thủy này lại có sơn là phục ngâm, chủ bại tài   <br> - Các sơn càn,giáp dần,tốn, ngọ đinh, thìn   là tấn thần.<br> Các sơn này cần có thủy trong 100m  ")
                elif 52.5<=float(bearing)<67.5:
                    n=(" 1.Toạ Thân(-6) Tấn 8 thổ khắc xuất hướng Dần 3 mộc nên là cục toạ Tấn nghi Thoái. Thư dự Thư<br> 2. Cửa chính,phụ: Mở ở hướng càn,thìn,đinh ngọ,thân canh, tuất <br> 3.Cung vị sơn:    sơn quý tý(tử), giáp dần(tôn), tốn(tôn)    là thoái thần <br> cần có núi, nhà cao, nhiều nhà ở xa từ 100 đến 1500m. Nếu ở sơn có thủy thì là phản ngâm chủ bại nhân đinh <br> -   sơn thìn, đinh ngọ, càn, thân canh, tuất    là tấn thần. <br> Các sơn này có núi, nhà cao tầng, nhiều nhà trong 100m trở lại.  <br>4. Các cung vị thuỷ:   mùi(tôn), nhâm hợi(tử),tân dậu(tôn)   là thoái thần. <br> Các sơn này có thuỷ, ngã tư đường, công viên bãi đỗ xe từ 100 đến 1500m. Nếu các thủy này lại có sơn là phục ngâm, chủ bại tài   <br>- Các sơn sửu, bính tỵ, khôn, mão ất, cấn   là tấn thần.<br> Các sơn này cần có thủy trong 100m ")
                elif 67.5<=float(bearing)<82.5:
                    n=(" 1.Toạ Canh(-1) Thoái 8 thổ khắc xuất hướng Giáp 3 mộc nên là cục toạ Thoái nghi Thoái. Hùng dự Hùng <br> 2. Cửa chính,phụ: Mở ở hướng Tý Quý, giáp dần, tốn<br> 3.Cung vị sơn:    sơn quý tý(tử), giáp dần(tôn), tốn(tôn)    là thoái thần <br> cần có núi, nhà cao, nhiều nhà ở xa từ 100 đến 1500m. Nếu ở sơn có thủy thì là phản ngâm chủ bại nhân đinh <br> -   sơn càn, thìn, đinh ngọ, thân canh, tuất    là tấn thần. <br> Các sơn này có núi, nhà cao tầng, nhiều nhà trong 100m trở lại.  <br>4. Các cung vị thuỷ:   tân dậu(tôn), nhâm hợi(tử), mùi (tôn)  là thoái thần. <br> Các sơn này có thuỷ, ngã tư đường, công viên bãi đỗ xe từ 100 đến 1500m. Nếu các thủy này lại có sơn là phục ngâm, chủ bại tài   <br>  - Các sơn sửu,bính tỵ, khôn,ất mão, cấn   là tấn thần.<br> Các sơn này cần có thủy trong 100m ")
                elif 82.5<=float(bearing)<97.5:
                    n=(" 1.Toạ Dậu(-7) Tấn 3 mộc cùng hành hướng Mão 8 thổ nên là cục toạ Tấn nghi Tấn. Hùng dự Thư<br> 2. Cửa chính,phụ: Mở ở hướng nhâm hợi, cấn, ất, mão, dậu tân, mùi  <br> 3.Cung vị sơn:      sơn sửu(tử), bính tỵ(tôn), khôn(tôn)    là thoái thần <br> cần có núi, nhà cao, nhiều nhà ở xa từ 100 đến 1500m. Nếu ở sơn có thủy thì là phản ngâm chủ bại nhân đinh <br> -   sơn nhâm hợi, cấn, ất mão, dậu tân, mùi    là tấn thần. <br> Các sơn này có núi, nhà cao tầng, nhiều nhà trong 100m trở lại.  <br>4. Các cung vị thuỷ:    càn(tử), thìn(tôn), đinh ngọ(tôn)   là thoái thần. <br> Các sơn này có thuỷ, ngã tư đường, công viên bãi đỗ xe từ 100 đến 1500m. Nếu các thủy này lại có sơn là phục ngâm, chủ bại tài   <br>  - Các sơn tuất, quý tý, canh thân, giáp dần, tuất   là tấn thần.<br> Các sơn này cần có thủy trong 100m ")
                elif 97.5<=float(bearing)<112.5:
                    n=(" 1.Toạ Tân(-2) Tấn 3 mộc khắc nhập hướng Ất 8 thổ nên là cục toạ Tấn nghi Tấn. Thư dự Hùng<br> 2. Cửa chính,phụ: Mở ở hướng nhâm hợi, cấn, ất, mão, mùi, dậu tân  <br> 3.Cung vị sơn:      sơn sửu(tử), bính tỵ(tôn), khôn(tôn)    là thoái thần <br> cần có núi, nhà cao, nhiều nhà ở xa từ 100 đến 1500m. Nếu ở sơn có thủy thì là phản ngâm chủ bại nhân đinh <br> -   sơn nhâm hợi, cấn, ất mão, mùi, dậu tân    là tấn thần. <br> Các sơn này có núi, nhà cao tầng, nhiều nhà trong 100m trở lại.  <br>4. Các cung vị thuỷ:    càn(tử), thìn(tôn), đinh ngọ(tôn)   là thoái thần. <br> Các sơn này có thuỷ, ngã tư đường, công viên bãi đỗ xe từ 100 đến 1500m. Nếu các thủy này lại có sơn là phục ngâm, chủ bại tài   <br>  - Các sơn tuất, quý tý, canh thân,giáp dần, tốn   là tấn thần.<br> Các sơn này cần có thủy trong 100m ")
                elif 112.5<=float(bearing)<127.5:
                    n=(" 1.Toạ Tuất(-6) Thoái 2 thổ sinh nhập hướng Thìn 7 kim nên là cục toạ Thoái nghi Tấn. Hùng dự Hùng <br> 2. Cửa chính,phụ: Mở ở hướng quý tý, giáp dần, tốn  <br> 3.Cung vị sơn:    sơn quý tý(tử), giáp dần(tôn), tốn(tôn)    là thoái thần <br> cần có núi, nhà cao, nhiều nhà ở xa từ 100 đến 1500m. Nếu ở sơn có thủy thì là phản ngâm chủ bại nhân đinh <br> -   sơn thìn, đinh ngọ, càn, thân canh, tuất    là tấn thần. <br> Các sơn này có núi, nhà cao tầng, nhiều nhà trong 100m trở lại.  <br>4. Các cung vị thuỷ:   nhâm hợi(tử), mùi(tôn), tân dậu(tôn)   là thoái thần. <br> Các sơn này có thuỷ, ngã tư đường, công viên bãi đỗ xe từ 100 đến 1500m. Nếu các thủy này lại có sơn là phục ngâm, chủ bại tài   <br>  - Các sơn sửu, bính tỵ, khôn, cấn, mão ất   là tấn thần.<br> Các sơn này cần có thủy trong 100m ")
                elif 127.5<=float(bearing)<142.5:
                    n=(" 1.Toạ Càn(-1) Tấn 9 hoả sinh nhập hướng Tốn 4 mộc nên là cục toạ Tấn nghi Tấn. Thư dự Thư<br> 2. Cửa chính,phụ: Mở ở hướng quý tý, giáp dần, tốn, càn  <br> 3.Cung vị sơn:    sơn thìn(tử), đinh ngọ(tử), canh thân(tôn), tuất(tử)    là thoái thần <br> cần có núi, nhà cao, nhiều nhà ở xa từ 100 đến 1500m. Nếu ở sơn có thủy thì là phản ngâm chủ bại nhân đinh <br> -   sơn tý quý, giáp dần, tốn, càn    là tấn thần. <br> Các sơn này có núi, nhà cao tầng, nhiều nhà trong 100m trở lại.  <br>4. Các cung vị thuỷ:   ất mão(tôn), tỵ bính(tử), khôn(tử), cấn(tôn)   là thoái thần. <br> Các sơn này có thuỷ, ngã tư đường, công viên bãi đỗ xe từ 100 đến 1500m. Nếu các thủy này lại có sơn là phục ngâm, chủ bại tài   <br> - Các sơn hợi nhâm, mùi, dậu tân, sửu   là tấn thần.<br> Các sơn này cần có thủy trong 100m ")
                elif 142.5<=float(bearing)<157.5:
                    n=(" 1.Toạ Hợi(2) Thoái 1 thuỷ khắc nhập hướng Tỵ 6 kim nên là cục toạ Thoái nghi Tấn. Thư dự Thư<br> 2. Cửa chính,phụ: Mở ở hướng mùi, dậu tân, sửu  <br> 3.Cung vị sơn:      sơn mùi(tử), dậu tân(tử), sửu(tôn)    là thoái thần <br> cần có núi, nhà cao, nhiều nhà ở xa từ 100 đến 1500m. Nếu ở sơn có thủy thì là phản ngâm chủ bại nhân đinh <br> -   sơn nhâm hợi, cấn ,ất mão, bính tỵ    là tấn thần. <br> Các sơn này có núi, nhà cao tầng, nhiều nhà trong 100m trở lại.  <br>4. Các cung vị thuỷ:    càn(tôn), giáp dần(tử), tốn(tử)   là thoái thần. <br> Các sơn này có thuỷ, ngã tư đường, công viên bãi đỗ xe từ 100 đến 1500m. Nếu các thủy này lại có sơn là phục ngâm, chủ bại tài   <br>  .<br> - Các sơn đinh ngọ, canh thân, tuất, quý tý, thìn   là tấn thần.<br> Các sơn này cần có thủy trong 100m ")
                elif 157.5<=float(bearing)<172.5:
                    n=(" 1.Toạ Nhâm(7) Tấn 1 thuỷ khắc nhập hướng Bính 6 kim nên là cục toạ Tấn nghi Tấn. Hùng dự Hùng<br> 2. Cửa chính,phụ: Mở ở hướng nhâm,cấn,ất mão, bính tỵ, khôn, nhâm hợi  <br> 3.Cung vị sơn:      sơn sửu(tôn), mùi(tử), tân dậu(tử)    là thoái thần <br> cần có núi, nhà cao, nhiều nhà ở xa từ 100 đến 1500m. Nếu ở sơn có thủy thì là phản ngâm chủ bại nhân đinh <br> -   sơn nhâm, cấn, ất mão, bính tỵ, khôn, nhâm hợi    là tấn thần. <br> Các sơn này có núi, nhà cao tầng, nhiều nhà trong 100m trở lại.  <br>4. Các cung vị thuỷ:    giáp dần(tử), tốn(tử), càn(tôn)   là thoái thần. <br> Các sơn này có thuỷ, ngã tư đường, công viên bãi đỗ xe từ 100 đến 1500m. Nếu các thủy này lại có sơn là phục ngâm, chủ bại tài   <br> - Các sơn quý tý, thìn, đinh ngọ, canh thân, tuất   là tấn thần.<br> Các sơn này cần có thủy trong 100m ")
                elif 172.5<=float(bearing)<187.5:
                    n=(" 1.Toạ Tý(1) Tấn 1 thuỷ khắc nhập hướng Ngọ 6 kim nên là cục toạ Tấn nghi Tấn. Thư dự Hùng<br> 2. Cửa chính,phụ: Mở ở hướng quý tý, thìn, đinh ngọ, canh thân, tuất  <br> 3.Cung vị sơn:    sơn càn(tôn), giáp dần(tử), tốn(tử)    là thoái thần <br> cần có núi, nhà cao, nhiều nhà ở xa từ 100 đến 1500m. Nếu ở sơn có thủy thì là phản ngâm chủ bại nhân đinh <br> -   sơn quý tý, thìn, đinh ngọ, canh thân, tuất    là tấn thần. <br> Các sơn này có núi, nhà cao tầng, nhiều nhà trong 100m trở lại.  <br>4. Các cung vị thuỷ:   sửu(tôn), mùi(tử), tân dậu(tử)   là thoái thần. <br> Các sơn này có thuỷ, ngã tư đường, công viên bãi đỗ xe từ 100 đến 1500m. Nếu các thủy này lại có sơn là phục ngâm, chủ bại tài   <br> - Các sơn nhâm, cấn, ất mão, bính tỵ, khôn, nhâm hợi   là tấn thần.<br> Các sơn này cần có thủy trong 100m ")
                elif 187.5<=float(bearing)<202.5:
                    n=(" 1.Toạ Quý(6) Thoái 1 thuỷ khắc nhập  hướng Đinh 6 kim nên là cục toạ Thoái nghi Tấn. Hùng dự Thư<br> 2. Cửa chính,phụ: Mở ở hướng giáp dần, tốn, càn <br> 3.Cung vị sơn:    sơn càn(tôn), giáp dần(tử), tốn(tử)    là thoái thần <br> cần có núi, nhà cao, nhiều nhà ở xa từ 100 đến 1500m. Nếu ở sơn có thủy thì là phản ngâm chủ bại nhân đinh <br> -   sơn quý tý, thìn, đinh ngọ, canh thân, tuất    là tấn thần. <br> Các sơn này có núi, nhà cao tầng, nhiều nhà trong 100m trở lại.  <br>4. Các cung vị thuỷ:   sửu(tôn), mùi(tử), tân dậu(tử)   là thoái thần. <br> Các sơn này có thuỷ, ngã tư đường, công viên bãi đỗ xe từ 100 đến 1500m. Nếu các thủy này lại có sơn là phục ngâm, chủ bại tài   <br>  .<br> - Các sơn nhâm, cấn, ất mão, bính tỵ, khôn, nhâm hợi   là tấn thần.<br> Các sơn này cần có thủy trong 100m ")
                elif 202.5<=float(bearing)<217.5:
                    n=(" 1.Toạ Sửu(-7) Tấn 9 hoả sinh nhập hướng Mùi 4 mộc nên là cục toạ Tấn nghi Tấn. Hùng dự Hùng<br> 2. Cửa chính,phụ: Mở ở hướng tân dậu, nhâm hợi, sửu, mùi  <br> 3.Cung vị sơn:      sơn khôn(tử), ất mão(tôn), bính tỵ(tử), cấn(tôn)    là thoái thần <br> cần có núi, nhà cao, nhiều nhà ở xa từ 100 đến 1500m. Nếu ở sơn có thủy thì là phản ngâm chủ bại nhân đinh <br> -   sơn tân dậu, nhâm hợi, sửu, mùi    là tấn thần. <br> Các sơn này có núi, nhà cao tầng, nhiều nhà trong 100m trở lại.  <br>4. Các cung vị thuỷ:    đinh ngọ(tử), canh thân(tôn), tuất(tôn), thìn(tử)   là thoái thần. <br> Các sơn này có thuỷ, ngã tư đường, công viên bãi đỗ xe từ 100 đến 1500m. Nếu các thủy này lại có sơn là phục ngâm, chủ bại tài   <br> - Các sơn càn, quý tý, giáp dần, tốn   là tấn thần.<br> Các sơn này cần có thủy trong 100m ")
                elif 217.5<=float(bearing)<232.5:
                    n=(" 1.Toạ Cấn(-2) Thoái 2 thổ sinh nhập hướng Khôn 7 kim nên là cục toạ Thoái nghi Tấn. Thư dự Thư<br> 2. Cửa chính,phụ: Mở ở hướng mùi, tân dậu, nhâm hợi <br> 3.Cung vị sơn:      sơn mùi(tôn), tân dậu(tôn), nhâm hợi(tử)    là thoái thần <br> cần có núi, nhà cao, nhiều nhà ở xa từ 100 đến 1500m. Nếu ở sơn có thủy thì là phản ngâm chủ bại nhân đinh <br> -   sơn khôn, cấn sửu, ất mão, bính tỵ    là tấn thần. <br> Các sơn này có núi, nhà cao tầng, nhiều nhà trong 100m trở lại.  <br>4. Các cung vị thuỷ:    quý tý(tử), giáp dần(tôn), tốn(tôn)   là thoái thần. <br> Các sơn này có thuỷ, ngã tư đường, công viên bãi đỗ xe từ 100 đến 1500m. Nếu các thủy này lại có sơn là phục ngâm, chủ bại tài   <br>  - Các sơn đinh ngọ, canh thân, tuất thìn, càn   là tấn thần.<br> Các sơn này cần có thủy trong 100m ")
                elif 232.5<=float(bearing)<247.5:
                    n=(" 1.Toạ Dần(1) Tấn 3 mộc khắc nhập hướng Thân 8 thổ nên là cục toạ Tấn nghi Tấn. Thư dự Thư<br> 2. Cửa chính,phụ: Mở ở hướng tuất, quý tý, canh thân, giáp dần, tốn  <br> 3.Cung vị sơn:    sơn càn(tử), thìn(tôn), đinh ngọ(tôn)    là thoái thần <br> cần có núi, nhà cao, nhiều nhà ở xa từ 100 đến 1500m. Nếu ở sơn có thủy thì là phản ngâm chủ bại nhân đinh <br> -   sơn tuất, quý tý, canh thân, giáp dần, tốn    là tấn thần. <br> Các sơn này có núi, nhà cao tầng, nhiều nhà trong 100m trở lại.  <br>4. Các cung vị thuỷ:   sửu(tử), bính tỵ(tôn), khôn(tôn)   là thoái thần. <br> Các sơn này có thuỷ, ngã tư đường, công viên bãi đỗ xe từ 100 đến 1500m. Nếu các thủy này lại có sơn là phục ngâm, chủ bại tài   <br> - Các sơn nhâm hợi, cấn, ất mão, dậu tân, mùi   là tấn thần.<br> Các sơn này cần có thủy trong 100m ")
                elif 247.5<=float(bearing)<262.5:
                    n=(" 1.Toạ Giáp(6) Tấn 3 mộc khắc nhập hướng Canh 8 thổ nên là cục toạ Tấn nghi Tấn. Hùng dự Hùng<br> 2. Cửa chính,phụ: Mở ở hướng tuất, quý tý, canh thân, giáp dần, tốn  <br> 3.Cung vị sơn:    sơn càn(tử), thìn(tôn), đinh ngọ(tôn)    là thoái thần <br> cần có núi, nhà cao, nhiều nhà ở xa từ 100 đến 1500m. Nếu ở sơn có thủy thì là phản ngâm chủ bại nhân đinh <br> -   sơn tuất, quý tý, canh thân, giáp dần, tốn    là tấn thần. <br> Các sơn này có núi, nhà cao tầng, nhiều nhà trong 100m trở lại.  <br>4. Các cung vị thuỷ:   sửu(tử), bính tỵ(tôn), khôn(tôn)   là thoái thần. <br> Các sơn này có thuỷ, ngã tư đường, công viên bãi đỗ xe từ 100 đến 1500m. Nếu các thủy này lại có sơn là phục ngâm, chủ bại tài   <br> - Các sơn nhâm hợi, cấn, ất mão, dậu tân, mùi   là tấn thần.<br> Các sơn này cần có thủy trong 100m ")
                elif 262.5<=float(bearing)<277.5:
                    n=(" 1.Toạ Mão(2) Thoái 8 thổ khắc xuất hướng Dậu 3 mộc nên là cục toạ Thoái nghi Thoái. Thư dự Hùng<br> 2. Cửa chính,phụ: Mở ở hướng mùi, tân dậu, nhâm hợi  <br> 3.Cung vị sơn:      sơn mùi(tôn), tân dậu(tôn), nhâm hợi(tử)    là thoái thần <br> cần có núi, nhà cao, nhiều nhà ở xa từ 100 đến 1500m. Nếu ở sơn có thủy thì là phản ngâm chủ bại nhân đinh <br> -   sơn khôn, cấn sửu, ất mão, bính tỵ    là tấn thần. <br> Các sơn này có núi, nhà cao tầng, nhiều nhà trong 100m trở lại.  <br>4. Các cung vị thuỷ:    quý tý(tử), giáp dần(tôn), tốn(tôn)   là thoái thần. <br> Các sơn này có thuỷ, ngã tư đường, công viên bãi đỗ xe từ 100 đến 1500m. Nếu các thủy này lại có sơn là phục ngâm, chủ bại tài   <br> - Các sơn đinh ngọ, canh thân, tuất, thìn, càn   là tấn thần.<br> Các sơn này cần có thủy trong 100m ")
                elif 277.5<=float(bearing)<292.5:
                    n=(" 1.Toạ Ất(7) Tấn 8 thổ khắc xuất hướng Tân 3 mộc nên là cục toạ Tấn nghi Thoái. Hùng dự thư<br> 2. Cửa chính,phụ: Mở ở hướng khôn, cấn sửu, ất mão, bính tỵ <br> 3.Cung vị sơn:      sơn mùi(tôn), tân dậu(tôn), nhâm hợi(tử)    là thoái thần <br> cần có núi, nhà cao, nhiều nhà ở xa từ 100 đến 1500m. Nếu ở sơn có thủy thì là phản ngâm chủ bại nhân đinh <br> -   sơn khôn, cấn sửu, ất mão, bính tỵ    là tấn thần. <br> Các sơn này có núi, nhà cao tầng, nhiều nhà trong 100m trở lại.  <br>4. Các cung vị thuỷ:    quý tý(tử), giáp dần(tôn), tốn(tôn)   là thoái thần. <br> Các sơn này có thuỷ, ngã tư đường, công viên bãi đỗ xe từ 100 đến 1500m. Nếu các thủy này lại có sơn là phục ngâm, chủ bại tài   <br> - Các sơn đinh ngọ, canh thân, tuất, thìn, càn   là tấn thần.<br> Các sơn này cần có thủy trong 100m ")
                elif 292.5<=float(bearing)<307.5:
                    n=(" 1.Toạ Thìn(1) Thoái 7 kim sinh xuất hướng Tuất 2 thổ nên là cục toạ Thoái nghi Thoái. Hùng dự Hùng<br> 2. Cửa chính,phụ: Mở ở hướng canh thân, tuất, quý tý  <br> 3.Cung vị sơn:    sơn quý tý(tôn), canh thân(tử), tuất(tử)    là thoái thần <br> cần có núi, nhà cao, nhiều nhà ở xa từ 100 đến 1500m. Nếu ở sơn có thủy thì là phản ngâm chủ bại nhân đinh <br> -   sơn càn, giáp dần, đinh ngọ, tốn thìn    là tấn thần. <br> Các sơn này có núi, nhà cao tầng, nhiều nhà trong 100m trở lại.  <br>4. Các cung vị thuỷ:   nhâm hợi(tôn), cấn(tử), ất mão(tử)   là thoái thần. <br> Các sơn này có thuỷ, ngã tư đường, công viên bãi đỗ xe từ 100 đến 1500m. Nếu các thủy này lại có sơn là phục ngâm, chủ bại tài   <br> - Các sơn sửu, bính tỵ, mùi khôn, tân dậu   là tấn thần.<br> Các sơn này cần có thủy trong 100m ")
                ...
                def extract_and_show_phongthuy(n_text):
                    ...
                    if all_son:
                        ...
                        st.markdown("#### 🏔️ Bảng cung vị sơn/thủy")
                        st.dataframe(df_son)
                    else:
